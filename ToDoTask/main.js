...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.chnageBtnText = function () {
        this.show = !this.show;
    };
...
module.exports = "<div class=\"blog-post\">\n  <h2 class=\"blog-post-title\"> {{post.title}}</h2>\n  <p class=\"blog-post-meta\">{{date | date: 'dd/MM/yyyy' }} <a href=\"#/posts\">{{post.id}}</a></p>\n\n  <p>{{post.body}}</p>\n</div>"
...
module.exports = __webpack_require__(/*! D:\nodeProjects\angular\ang6\PerfectWeb\ToDoTask\src\main.ts */"./src/main.ts");
